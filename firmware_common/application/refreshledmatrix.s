...
;-----------------------------------------------------------------------------
; RefreshLedMatrix(u8* pu8Address_, u32 u32Bytes_)
; 
...
ZERO_BIT                             ; 14 cycles high, 44 cycles low
  MOV   r6, #3                       ; 132: Load r6 loop counter to kill cycles [1]
...
ZeroBitShortLoop
  ...
  MOV   r6, #7                       ; 146 [1]: Load r6 loop counter to kill cycles
...
ONE_BIT                              ; 44 cycles high, 14 cycles low
  MOV   r6, #11                       ; 77 [1]: Load r6 loop counter to kill cycles
OneBitLoop
  SUBS  r6, r6, #1                   ; : Decrement r6, update flags
